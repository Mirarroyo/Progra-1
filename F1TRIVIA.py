...
# falta que hace el programa y bibliotecas y explivar el uso del random en read me y .py welp estudiaaaaar 
import random  
...
def las_preguntas(pregunta, opciones, respuesta_correcta):
    ...
    e internamente devuelve un 1 si la respuesta es correcta o 0 si no
    """
